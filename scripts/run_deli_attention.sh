...
#   creating a dedicated output phase that receives the exact-match reward directly.
...
#   HIDDEN_PCA_COMPONENTS=32 bash scripts/run_deli_attention.sh   # OOM-safe
#   NUM_GPUS=4 GPU_MEM_UTIL=0.6 bash scripts/run_deli_attention.sh
# =============================================================================
set -euo pipefail
