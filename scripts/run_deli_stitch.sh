...
#   creating a clean reasoning/output boundary for stitching.
...
#     2. Split golden solution into phases using same DeliEntropySplitter
#        (</think> boundary respected in golden solution too)
...
#   NUM_GPUS=4 GPU_MEM_UTIL=0.6 bash scripts/run_deli_stitch.sh
# =============================================================================
set -euo pipefail
