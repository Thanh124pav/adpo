...
TRAIN_DATA=${TRAIN_DATA:-"data/processed/train/fine_math.parquet"}
...
EPOCHS=${EPOCHS:-1}
BETA=${BETA:-1.0}
EXPERIMENT=${EXPERIMENT:-"adpo-qwen7b-finemath"}
OUTPUT_DIR=${OUTPUT_DIR:-"checkpoints/$EXPERIMENT"}

echo "============================================="
echo " ADPO Training — fine_math"
echo " Model:      $MODEL"
echo " Beta:       $BETA"
echo " GPUs:       $NUM_GPUS"
echo "============================================="
