...
TRAIN_DATA=${TRAIN_DATA:-"data/processed/train/big_math_rl.parquet"}
...
EPOCHS=${EPOCHS:-1}
BETA=${BETA:-1.0}
EXPERIMENT=${EXPERIMENT:-"adpo-qwen7b-bigmathrl"}
OUTPUT_DIR=${OUTPUT_DIR:-"checkpoints/$EXPERIMENT"}

echo "============================================="
echo " ADPO Training — big_math_rl"
echo " Model:      $MODEL"
echo " Beta:       $BETA"
echo " GPUs:       $NUM_GPUS"
echo "============================================="
